...
Elm.Languages.Models = Elm.Languages.Models || {};
Elm.Languages.Models.make = function (_elm) {
   "use strict";
   _elm.Languages = _elm.Languages || {};
   _elm.Languages.Models = _elm.Languages.Models || {};
   if (_elm.Languages.Models.values) return _elm.Languages.Models.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var languages = _U.list([{id: 1,name: "Elm",image: "elm",tags: _U.list(["functional","browser","static"])}
                           ,{id: 2,name: "JavaScript",image: "js",tags: _U.list(["functional","oo","browser","dynamic","prototypical"])}
                           ,{id: 3,name: "Go",image: "go",tags: _U.list(["oo","google","static"])}
                           ,{id: 4,name: "Rust",image: "rust",tags: _U.list(["functional","mozilla","static"])}
                           ,{id: 5,name: "Elixir",image: "elixir",tags: _U.list(["functional","erlang","dynamic"])}
                           ,{id: 6,name: "Ruby",image: "ruby",tags: _U.list(["oo","japan","1996","dynamic","classical"])}
                           ,{id: 7,name: "Python",image: "python",tags: _U.list(["oo","dynamic","classical"])}
                           ,{id: 8,name: "Swift",image: "swift",tags: _U.list(["functional","apple","static","classical"])}
                           ,{id: 9,name: "Haskell",image: "haskell",tags: _U.list(["functional","static"])}
                           ,{id: 10,name: "Java",image: "java",tags: _U.list(["oo","static","classical"])}
                           ,{id: 11,name: "C#",image: "csharp",tags: _U.list(["oo","microsoft","static","classical"])}
                           ,{id: 12,name: "PHP",image: "php",tags: _U.list(["oo","server","1994","dynamic","classical"])}]);
   var NotFoundRoute = {ctor: "NotFoundRoute"};
   var LanguageEditRoute = function (a) {    return {ctor: "LanguageEditRoute",_0: a};};
   var LanguageRoute = function (a) {    return {ctor: "LanguageRoute",_0: a};};
   var LanguagesRoute = {ctor: "LanguagesRoute"};
   var Language = F4(function (a,b,c,d) {    return {id: a,name: b,image: c,tags: d};});
   return _elm.Languages.Models.values = {_op: _op
                                         ,Language: Language
                                         ,LanguagesRoute: LanguagesRoute
                                         ,LanguageRoute: LanguageRoute
                                         ,LanguageEditRoute: LanguageEditRoute
                                         ,NotFoundRoute: NotFoundRoute
                                         ,languages: languages};
};
Elm.Languages = Elm.Languages || {};
Elm.Languages.Actions = Elm.Languages.Actions || {};
Elm.Languages.Actions.make = function (_elm) {
   "use strict";
   _elm.Languages = _elm.Languages || {};
   _elm.Languages.Actions = _elm.Languages.Actions || {};
   if (_elm.Languages.Actions.values) return _elm.Languages.Actions.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Dict = Elm.Dict.make(_elm),
   $Languages$Models = Elm.Languages.Models.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   ...
   var AddQuery = function (a) {    return {ctor: "AddQuery",_0: a};};
   var Update = F3(function (a,b,c) {    return {ctor: "Update",_0: a,_1: b,_2: c};});
   var Edit = function (a) {    return {ctor: "Edit",_0: a};};
   var Show = function (a) {    return {ctor: "Show",_0: a};};
   return _elm.Languages.Actions.values = {_op: _op
                                          ,Show: Show
                                          ,Edit: Edit
                                          ,Update: Update
                                          ,AddQuery: AddQuery
...
Elm.Models.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var AppModel = F4(function (a,b,c,d) {    return {languages: a,location: b,route: c,selectedLanguage: d};});
   var NotFoundRoute = {ctor: "NotFoundRoute"};
   var LanguagesRoutes = function (a) {    return {ctor: "LanguagesRoutes",_0: a};};
   var AboutRoute = {ctor: "AboutRoute"};
   var newAppModel = {languages: $Languages$Models.languages,location: $Hop$Types.newLocation,route: AboutRoute,selectedLanguage: $Maybe.Nothing};
   var HomeRoute = {ctor: "HomeRoute"};
   return _elm.Models.values = {_op: _op
                               ,HomeRoute: HomeRoute
                               ,AboutRoute: AboutRoute
                               ,LanguagesRoutes: LanguagesRoutes
                               ,NotFoundRoute: NotFoundRoute
                               ,AppModel: AppModel
...
Elm.Actions.make = function (_elm) {
   ...
   $Debug = Elm.Debug.make(_elm),
   $Hop$Types = Elm.Hop.Types.make(_elm),
   $Languages$Actions = Elm.Languages.Actions.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var LanguagesAction = function (a) {    return {ctor: "LanguagesAction",_0: a};};
   var SetQuery = function (a) {    return {ctor: "SetQuery",_0: a};};
   var NavigateTo = function (a) {    return {ctor: "NavigateTo",_0: a};};
   ...
   return _elm.Actions.values = {_op: _op
                                ...
                                ,NavigateTo: NavigateTo
                                ,SetQuery: SetQuery
                                ,LanguagesAction: LanguagesAction};
};
Elm.Hop = Elm.Hop || {};
...
Elm.Hop.Navigate.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var navigateToLocation = F2(function (config,location) {    return $Effects.task($History.setPath(A2($Hop$Location.locationToFullPath,config,location)));});
...
Elm.Languages = Elm.Languages || {};
Elm.Languages.Edit = Elm.Languages.Edit || {};
Elm.Languages.Edit.make = function (_elm) {
   "use strict";
   _elm.Languages = _elm.Languages || {};
   _elm.Languages.Edit = _elm.Languages.Edit || {};
   if (_elm.Languages.Edit.values) return _elm.Languages.Edit.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var styles = $Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "float",_1: "left"}]));
   var view = F2(function (address,language) {
      return A2($Html.div,
      _U.list([styles]),
      _U.list([A2($Html.h2,_U.list([]),_U.list([$Html.text(language.name)]))
              ,A2($Html.form,
              _U.list([]),
              _U.list([A2($Html.input,
              _U.list([$Html$Attributes.value(language.name)
                      ,$Html$Attributes.name("name")
                      ,A3($Html$Events.on,
                      "input",
                      $Html$Events.targetValue,
                      function (_p0) {
                         return A2($Signal.message,address,A3($Languages$Actions.Update,language.id,"name",_p0));
                      })]),
              _U.list([]))]))]));
   });
   return _elm.Languages.Edit.values = {_op: _op,styles: styles,view: view};
};
Elm.Languages = Elm.Languages || {};
Elm.Languages.Filter = Elm.Languages.Filter || {};
Elm.Languages.Filter.make = function (_elm) {
   "use strict";
   _elm.Languages = _elm.Languages || {};
   _elm.Languages.Filter = _elm.Languages.Filter || {};
   if (_elm.Languages.Filter.values) return _elm.Languages.Filter.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Dict = Elm.Dict.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var btn = F4(function (address,viewId,label,action) {
      return A2($Html.button,
      _U.list([$Html$Attributes.id(viewId),$Html$Attributes.$class("btn btn-primary btn-small inline-block mr1"),A2($Html$Events.onClick,address,action)]),
      _U.list([$Html.text(label)]));
   });
   var styles = $Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "float",_1: "left"}
                                               ,{ctor: "_Tuple2",_0: "margin-left",_1: "2rem"}
                                               ,{ctor: "_Tuple2",_0: "margin-right",_1: "2rem"}]));
   var view = F2(function (address,model) {
      return A2($Html.div,
      _U.list([styles]),
      _U.list([A2($Html.h2,_U.list([]),_U.list([$Html.text("Filter")]))
              ,A4(btn,address,"btnSetQuery","SetQuery",$Languages$Actions.SetQuery(A2($Dict.singleton,"latests","true")))
              ,A2($Html.div,
              _U.list([]),
              _U.list([A2($Html.h3,_U.list([]),_U.list([$Html.text("Kind")]))
                      ,A2($Html.div,
                      _U.list([]),
                      _U.list([A4(btn,address,"btnAll","All",$Languages$Actions.AddQuery(A2($Dict.singleton,"typed","")))
                              ,A4(btn,address,"btnDynamic","Dynamic",$Languages$Actions.AddQuery(A2($Dict.singleton,"typed","dynamic")))
                              ,A4(btn,address,"btnStatic","Static",$Languages$Actions.AddQuery(A2($Dict.singleton,"typed","static")))]))]))]));
   });
   var ViewModel = {};
   return _elm.Languages.Filter.values = {_op: _op,ViewModel: ViewModel,styles: styles,view: view,btn: btn};
};
Elm.Languages = Elm.Languages || {};
Elm.Languages.List = Elm.Languages.List || {};
Elm.Languages.List.make = function (_elm) {
   "use strict";
   _elm.Languages = _elm.Languages || {};
   _elm.Languages.List = _elm.Languages.List || {};
   if (_elm.Languages.List.values) return _elm.Languages.List.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Dict = Elm.Dict.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var actionBtn = F3(function (address,action,label) {
      return A2($Html.button,_U.list([$Html$Attributes.$class("regular btn btn-small"),A2($Html$Events.onClick,address,action)]),_U.list([$Html.text(label)]));
   });
   var rowView = F2(function (address,language) {
      return A2($Html.tr,
      _U.list([]),
      _U.list([A2($Html.td,_U.list([]),_U.list([$Html.text($Basics.toString(language.id))]))
              ,A2($Html.td,_U.list([]),_U.list([$Html.text(language.name)]))
              ,A2($Html.td,
              _U.list([]),
              _U.list([A3(actionBtn,address,$Languages$Actions.Show(language.id),"Show")
                      ,A3(actionBtn,address,$Languages$Actions.Edit(language.id),"Edit")]))]));
   });
   var tableRows = F2(function (address,collection) {    return A2($List.map,rowView(address),collection);});
   var hasTag = F2(function (tag,language) {    return A2($List.any,function (t) {    return _U.eq(t,tag);},language.tags);});
   var filteredLanguages = function (model) {
      var typed = A2($Maybe.withDefault,"",A2($Dict.get,"typed",model.location.query));
      var _p0 = typed;
      if (_p0 === "") {
            return model.languages;
         } else {
            return A2($List.filter,hasTag(typed),model.languages);
         }
   };
   var styles = $Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "float",_1: "left"},{ctor: "_Tuple2",_0: "margin-right",_1: "2rem"}]));
   var view = F2(function (address,model) {
      return A2($Html.div,
      _U.list([styles]),
      _U.list([A2($Html.h2,_U.list([]),_U.list([$Html.text("Languages")]))
              ,A2($Html.table,_U.list([]),_U.list([A2($Html.tbody,_U.list([]),A2(tableRows,address,filteredLanguages(model)))]))]));
   });
   var ViewModel = F2(function (a,b) {    return {languages: a,location: b};});
   return _elm.Languages.List.values = {_op: _op
                                       ,ViewModel: ViewModel
                                       ,styles: styles
                                       ,hasTag: hasTag
...
Elm.Languages = Elm.Languages || {};
Elm.Languages.Routing = Elm.Languages.Routing || {};
Elm.Languages.Routing.Config = Elm.Languages.Routing.Config || {};
Elm.Languages.Routing.Config.make = function (_elm) {
   "use strict";
   _elm.Languages = _elm.Languages || {};
   _elm.Languages.Routing = _elm.Languages.Routing || {};
   _elm.Languages.Routing.Config = _elm.Languages.Routing.Config || {};
   if (_elm.Languages.Routing.Config.values) return _elm.Languages.Routing.Config.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Hop$Matchers = Elm.Hop.Matchers.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var matcherLanguageEdit = A4($Hop$Matchers.match3,$Languages$Models.LanguageEditRoute,"/",$Hop$Matchers.$int,"/edit");
   var matcherLanguage = A3($Hop$Matchers.match2,$Languages$Models.LanguageRoute,"/",$Hop$Matchers.$int);
   var matcherLanguages = A2($Hop$Matchers.match1,$Languages$Models.LanguagesRoute,"");
   var matchers = _U.list([matcherLanguages,matcherLanguage,matcherLanguageEdit]);
   return _elm.Languages.Routing.Config.values = {_op: _op
                                                 ,matcherLanguages: matcherLanguages
                                                 ,matcherLanguage: matcherLanguage
                                                 ,matcherLanguageEdit: matcherLanguageEdit
                                                 ,matchers: matchers};
};
...
Elm.Routing.Config.make = function (_elm) {
   ...
   $Hop$Matchers = Elm.Hop.Matchers.make(_elm),
   $Hop$Types = Elm.Hop.Types.make(_elm),
   $Languages$Routing$Config = Elm.Languages.Routing.Config.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Models = Elm.Models.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var matchersLanguages = A3($Hop$Matchers.nested1,$Models.LanguagesRoutes,"/languages",$Languages$Routing$Config.matchers);
   var matcherAbout = A2($Hop$Matchers.match1,$Models.AboutRoute,"/about");
   var matcherHome = A2($Hop$Matchers.match1,$Models.HomeRoute,"");
   var matchers = _U.list([matcherHome,matcherAbout,matchersLanguages]);
   var config = {basePath: "/app",hash: false,matchers: matchers,notFound: $Models.NotFoundRoute};
   return _elm.Routing.Config.values = {_op: _op
                                       ,matcherHome: matcherHome
                                       ,matcherAbout: matcherAbout
                                       ,matchersLanguages: matchersLanguages
                                       ,matchers: matchers
                                       ,config: config};
};
Elm.Languages = Elm.Languages || {};
Elm.Languages.Routing = Elm.Languages.Routing || {};
Elm.Languages.Routing.Utils = Elm.Languages.Routing.Utils || {};
Elm.Languages.Routing.Utils.make = function (_elm) {
   "use strict";
   _elm.Languages = _elm.Languages || {};
   _elm.Languages.Routing = _elm.Languages.Routing || {};
   _elm.Languages.Routing.Utils = _elm.Languages.Routing.Utils || {};
   if (_elm.Languages.Routing.Utils.values) return _elm.Languages.Routing.Utils.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Hop$Matchers = Elm.Hop.Matchers.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var toS = $Basics.toString;
   var reverse = function (route) {
      var _p0 = route;
      switch (_p0.ctor)
      {case "LanguagesRoute": return A2($Hop$Matchers.matcherToPath,$Languages$Routing$Config.matcherLanguages,_U.list([]));
         case "LanguageRoute": return A2($Hop$Matchers.matcherToPath,$Languages$Routing$Config.matcherLanguage,_U.list([toS(_p0._0)]));
         case "LanguageEditRoute": return A2($Hop$Matchers.matcherToPath,$Languages$Routing$Config.matcherLanguageEdit,_U.list([toS(_p0._0)]));
         default: return "";}
   };
   var reverseWithPrefix = function (route) {    return A2($Basics._op["++"],"/languages",reverse(route));};
   var config = $Routing$Config.config;
   return _elm.Languages.Routing.Utils.values = {_op: _op,config: config,toS: toS,reverseWithPrefix: reverseWithPrefix,reverse: reverse};
};
Elm.Languages = Elm.Languages || {};
Elm.Languages.Show = Elm.Languages.Show || {};
Elm.Languages.Show.make = function (_elm) {
   "use strict";
   _elm.Languages = _elm.Languages || {};
   _elm.Languages.Show = _elm.Languages.Show || {};
   if (_elm.Languages.Show.values) return _elm.Languages.Show.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var tag = F2(function (address,tagName) {    return A2($Html.span,_U.list([]),_U.list([$Html.text(A2($Basics._op["++"],tagName,", "))]));});
   var tags = F2(function (address,language) {    return A2($Html.div,_U.list([]),A2($List.map,tag(address),language.tags));});
   var styles = $Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "float",_1: "left"}]));
   var view = F2(function (address,language) {
      return A2($Html.div,
      _U.list([styles]),
      _U.list([A2($Html.h2,_U.list([$Html$Attributes.id("titleLanguage")]),_U.list([$Html.text(language.name)]))
              ,A2($Html.img,_U.list([$Html$Attributes.src(A2($Basics._op["++"],"/images/",A2($Basics._op["++"],language.image,".png")))]),_U.list([]))
              ,A2(tags,address,language)]));
   });
   return _elm.Languages.Show.values = {_op: _op,styles: styles,view: view,tags: tags,tag: tag};
};
Elm.Languages = Elm.Languages || {};
Elm.Languages.Update = Elm.Languages.Update || {};
Elm.Languages.Update.make = function (_elm) {
   "use strict";
   _elm.Languages = _elm.Languages || {};
   _elm.Languages.Update = _elm.Languages.Update || {};
   if (_elm.Languages.Update.values) return _elm.Languages.Update.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   ...
   $Languages$Actions = Elm.Languages.Actions.make(_elm),
   $Languages$Models = Elm.Languages.Models.make(_elm),
   $Languages$Routing$Utils = Elm.Languages.Routing.Utils.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Models = Elm.Models.make(_elm),
   $Result = Elm.Result.make(_elm),
   ...
   $Task = Elm.Task.make(_elm);
   var _op = {};
   var updateWithId = F4(function (id,prop,value,language) {
      if (_U.eq(id,language.id)) {
            var _p0 = prop;
            if (_p0 === "name") {
                  return _U.update(language,{name: value});
               } else {
                  return language;
               }
         } else return language;
   });
   var routerConfig = $Routing$Config.config;
   var update = F2(function (action,model) {
      var _p1 = A2($Debug.log,"action",action);
      switch (_p1.ctor)
      {case "NavigateTo": return {ctor: "_Tuple2"
                                 ,_0: model
                                 ,_1: A2($Effects.map,$Languages$Actions.HopAction,A2($Hop$Navigate.navigateTo,$Routing$Config.config,_p1._0))};
         case "Show": var path = $Languages$Routing$Utils.reverseWithPrefix($Languages$Models.LanguageRoute(_p1._0));
           var fx = $Effects.task($Task.succeed($Languages$Actions.NavigateTo(path)));
           return {ctor: "_Tuple2",_0: model,_1: fx};
         case "Edit": var path = $Languages$Routing$Utils.reverseWithPrefix($Languages$Models.LanguageEditRoute(_p1._0));
           var fx = $Effects.task($Task.succeed($Languages$Actions.NavigateTo(path)));
           return {ctor: "_Tuple2",_0: model,_1: fx};
         case "Update": var udpatedLanguages = A2($List.map,A3(updateWithId,_p1._0,_p1._1,_p1._2),model.languages);
           return {ctor: "_Tuple2",_0: _U.update(model,{languages: udpatedLanguages}),_1: $Effects.none};
         case "AddQuery": var fx = A2($Effects.map,$Languages$Actions.HopAction,A3($Hop$Navigate.addQuery,routerConfig,_p1._0,model.location));
           return {ctor: "_Tuple2",_0: model,_1: fx};
         case "SetQuery": var fx = A2($Effects.map,$Languages$Actions.HopAction,A3($Hop$Navigate.setQuery,routerConfig,_p1._0,model.location));
           return {ctor: "_Tuple2",_0: model,_1: fx};
         default: return {ctor: "_Tuple2",_0: model,_1: $Effects.none};}
   });
   var UpdateModel = F2(function (a,b) {    return {languages: a,location: b};});
   return _elm.Languages.Update.values = {_op: _op,UpdateModel: UpdateModel,routerConfig: routerConfig,update: update,updateWithId: updateWithId};
};
Elm.Languages = Elm.Languages || {};
Elm.Languages.View = Elm.Languages.View || {};
Elm.Languages.View.make = function (_elm) {
   "use strict";
   _elm.Languages = _elm.Languages || {};
   _elm.Languages.View = _elm.Languages.View || {};
   if (_elm.Languages.View.values) return _elm.Languages.View.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Hop$Types = Elm.Hop.Types.make(_elm),
   ...
   $Html$Attributes = Elm.Html.Attributes.make(_elm),
   $Languages$Actions = Elm.Languages.Actions.make(_elm),
   $Languages$Edit = Elm.Languages.Edit.make(_elm),
   $Languages$Filter = Elm.Languages.Filter.make(_elm),
   $Languages$List = Elm.Languages.List.make(_elm),
   $Languages$Models = Elm.Languages.Models.make(_elm),
   $Languages$Show = Elm.Languages.Show.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var getLanguage = F2(function (languages,id) {    return $List.head(A2($List.filter,function (lang) {    return _U.eq(lang.id,id);},languages));});
   var notFoundView = F2(function (address,model) {    return A2($Html.div,_U.list([]),_U.list([$Html.text("Not Found")]));});
   var emptyView = A2($Html.span,_U.list([]),_U.list([]));
   var subView = F2(function (address,model) {
      var _p0 = model.route;
      switch (_p0.ctor)
      {case "LanguageRoute": var maybeLanguage = A2(getLanguage,model.languages,_p0._0);
           var _p1 = maybeLanguage;
           if (_p1.ctor === "Just") {
                 return A2($Languages$Show.view,address,_p1._0);
              } else {
                 return A2(notFoundView,address,model);
              }
         case "LanguageEditRoute": var maybeLanguage = A2(getLanguage,model.languages,_p0._0);
           var _p2 = maybeLanguage;
           if (_p2.ctor === "Just") {
                 return A2($Languages$Edit.view,address,_p2._0);
              } else {
                 return A2(notFoundView,address,model);
              }
         case "LanguagesRoute": return emptyView;
         default: return A2(notFoundView,address,model);}
   });
   var containerStyle = $Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "margin-bottom",_1: "5rem"},{ctor: "_Tuple2",_0: "overflow",_1: "auto"}]));
   var view = F2(function (address,model) {
      return A2($Html.div,
      _U.list([containerStyle]),
      _U.list([A2($Languages$Filter.view,address,{})
              ,A2($Languages$List.view,address,{languages: model.languages,location: model.location})
              ,A2(subView,address,model)]));
   });
   var ViewModel = F3(function (a,b,c) {    return {languages: a,location: b,route: c};});
   return _elm.Languages.View.values = {_op: _op
                                       ,ViewModel: ViewModel
...
Elm.Update.make = function (_elm) {
   ...
   $Effects = Elm.Effects.make(_elm),
   $Hop$Navigate = Elm.Hop.Navigate.make(_elm),
   $Languages$Update = Elm.Languages.Update.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Models = Elm.Models.make(_elm),
   $Result = Elm.Result.make(_elm),
   ...
   var update = F2(function (action,model) {
      ...
      switch (_p0.ctor)
      {case "LanguagesAction": var updateModel = {languages: model.languages,location: model.location};
           var _p1 = A2($Languages$Update.update,_p0._0,updateModel);
           var updatedModel = _p1._0;
           var fx = _p1._1;
           return {ctor: "_Tuple2",_0: _U.update(model,{languages: updatedModel.languages}),_1: A2($Effects.map,$Actions.LanguagesAction,fx)};
         case "NavigateTo": return {ctor: "_Tuple2"
                                   ,_0: model
                                   ,_1: A2($Effects.map,$Actions.HopAction,A2($Hop$Navigate.navigateTo,$Routing$Config.config,_p0._0))};
         case "ApplyRoute": return {ctor: "_Tuple2",_0: _U.update(model,{route: _p0._0._0,location: _p0._0._1}),_1: $Effects.none};
         case "SetQuery": return {ctor: "_Tuple2"
                                 ,_0: model
                                 ,_1: A2($Effects.map,$Actions.HopAction,A3($Hop$Navigate.setQuery,$Routing$Config.config,_p0._0,model.location))};
         default: return {ctor: "_Tuple2",_0: model,_1: $Effects.none};}
   });
   return _elm.Update.values = {_op: _op,update: update};
};
Elm.Routing = Elm.Routing || {};
Elm.Routing.Utils = Elm.Routing.Utils || {};
Elm.Routing.Utils.make = function (_elm) {
   "use strict";
   _elm.Routing = _elm.Routing || {};
   _elm.Routing.Utils = _elm.Routing.Utils || {};
   if (_elm.Routing.Utils.values) return _elm.Routing.Utils.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Hop$Matchers = Elm.Hop.Matchers.make(_elm),
   ...
   var reverse = function (route) {
      var _p0 = route;
      switch (_p0.ctor)
      {case "HomeRoute": return A2($Hop$Matchers.matcherToPath,$Routing$Config.matcherHome,_U.list([]));
         case "AboutRoute": return A2($Hop$Matchers.matcherToPath,$Routing$Config.matcherAbout,_U.list([]));
         case "LanguagesRoutes": var subPath = $Languages$Routing$Utils.reverse(_p0._0);
           var parentPath = A2($Hop$Matchers.matcherToPath,$Routing$Config.matchersLanguages,_U.list([]));
           return A2($Basics._op["++"],parentPath,subPath);
         default: return "";}
   };
   return _elm.Routing.Utils.values = {_op: _op,reverse: reverse};
};
Elm.View = Elm.View || {};
Elm.View.make = function (_elm) {
   ...
   $Html$Events = Elm.Html.Events.make(_elm),
   $Languages$Models = Elm.Languages.Models.make(_elm),
   $Languages$View = Elm.Languages.View.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Models = Elm.Models.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Routing$Utils = Elm.Routing.Utils.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var notFoundView = F2(function (address,model) {    return A2($Html.div,_U.list([]),_U.list([$Html.text("Not Found")]));});
   var pageView = F2(function (address,model) {
      var _p0 = model.route;
      switch (_p0.ctor)
      {case "HomeRoute": return A2($Html.div,
           _U.list([$Html$Attributes.$class("p2")]),
           _U.list([A2($Html.h1,_U.list([$Html$Attributes.id("title"),$Html$Attributes.$class("m0")]),_U.list([$Html.text("Home")]))
                   ,A2($Html.div,_U.list([]),_U.list([$Html.text("Click on Languages to start routing")]))]));
         case "AboutRoute": return A2($Html.div,
           _U.list([$Html$Attributes.$class("p2")]),
           _U.list([A2($Html.h1,_U.list([$Html$Attributes.id("title"),$Html$Attributes.$class("m0")]),_U.list([$Html.text("About")]))]));
         case "LanguagesRoutes": var viewModel = {languages: model.languages,route: _p0._0,location: model.location};
           return A2($Html.div,
           _U.list([$Html$Attributes.$class("p2")]),
           _U.list([A2($Html.h1,_U.list([$Html$Attributes.id("title"),$Html$Attributes.$class("m0")]),_U.list([$Html.text("Languages")]))
                   ,A2($Languages$View.view,A2($Signal.forwardTo,address,$Actions.LanguagesAction),viewModel)]));
         default: return A2(notFoundView,address,model);}
   });
   var menuLink = F4(function (address,route,viewId,label) {
      var path = $Routing$Utils.reverse(route);
      var action = $Actions.NavigateTo(path);
      return A2($Html.a,
      _U.list([$Html$Attributes.id(viewId)
              ,$Html$Attributes.href("javascript://")
              ,A2($Html$Events.onClick,address,action)
              ,$Html$Attributes.$class("white px2")]),
      _U.list([$Html.text(label)]));
   });
   var menu = F2(function (address,model) {
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("p2 white bg-black")]),
      _U.list([A2($Html.div,
      _U.list([]),
      _U.list([A4(menuLink,address,$Models.HomeRoute,"btnHome","Home")
              ,$Html.text("|")
              ,A4(menuLink,address,$Models.LanguagesRoutes($Languages$Models.LanguagesRoute),"btnLanguages","Languages")
              ,$Html.text("|")
              ,A4(menuLink,address,$Models.AboutRoute,"btnAbout","About")]))]));
   });
   var view = F2(function (address,model) {    return A2($Html.div,_U.list([]),_U.list([A2(menu,address,model),A2(pageView,address,model)]));});
   return _elm.View.values = {_op: _op,view: view,menu: menu,menuLink: menuLink,pageView: pageView,notFoundView: notFoundView};
};
Elm.Main = Elm.Main || {};
Elm.Main.make = function (_elm) {
   ...
   var routerSignal = A2($Signal.map,$Actions.ApplyRoute,router.signal);
   var routeRunTask = Elm.Native.Task.make(_elm).perform(router.run);
   var init = {ctor: "_Tuple2",_0: $Models.newAppModel,_1: $Effects.none};
   var app = $StartApp.start({init: init,update: $Update.update,view: $View.view,inputs: _U.list([routerSignal])});
   var main = app.html;
   var tasks = Elm.Native.Task.make(_elm).performSignal("tasks",app.tasks);
   return _elm.Main.values = {_op: _op,init: init,router: router,routerSignal: routerSignal,app: app,main: main};
};
